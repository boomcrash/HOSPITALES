...
public class ActionListenerConsultaConsultas implements ActionListener {
	
        private JPanel base,reemplazo;
	
	public ActionListenerConsultaConsultas(JPanel base,JPanel reemplazo) {
                this.base=base;
...
*
* Creado el 06 de Marzo, 2022, 18:30 horas
*
